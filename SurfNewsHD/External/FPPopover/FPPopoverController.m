...
-(void)setContentPonit
{
    //_fromView
   
    CGPoint point1 = [self.view convertPoint:CGPointMake(10, 0) fromView:_fromView];
    
    CGPoint point2 = [_contentView convertPoint:point1 fromView:self.view];
    _contentView.point = point2;
